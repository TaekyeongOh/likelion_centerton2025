...
import qr from '../../assets/img/Customer/menu/qr.svg'
import language from '../../assets/img/Customer/menu/language.svg'
import main from '../../assets/img/Customer/menu/main.png'
import header from '../../assets/img/Customer/menu/header.png'
import cart from '../../assets/img/Customer/menu/cart.svg'
      ...
      <img src={main} alt="" className="main" />
        ...
        <main>
          ...
          <div className="menu">
            ...
            <div id='menu' className="menu4">
                <div className="text">
                  <h1>해물순두부찌개</h1>
                  <p>순한 맛의 순두부에 새우, 오징어, 바지락
                    <br />이 푸짐하게.
                  </p>
                </div>
                <div className="order">
            ...
            <div id='menu' className="menu5">
                <div className="text">
                  <h1>김치전</h1>
                  <p>바삭한 김치전과 상큼한 유자에이드가
                    <br />함께 나오는 간단한 브런치 세트.
                  </p>
                </div>
                <div className="order">
                  <button className="order_btn">
